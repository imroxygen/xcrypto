    ...
    <Container maxW={"container.xl"}>
      {
        loading ? <Loader /> : (
          <>
            ...
            <VStack spacing={"4"} p={"16"} alignSelf={"flex-start"}>
              ...
              <Stat>
                ...
                <StatNumber>{currecySymbol}{coin.market_data.current_price[currency]}</StatNumber>
              ...
              <CustomBar
                high={`${currecySymbol}${coin.market_data.high_24h[currency]}`}
                low={`${currecySymbol}${coin.market_data.low_24h[currency]}`} />
